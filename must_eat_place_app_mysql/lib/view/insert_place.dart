...
@override
  ...
  var url = Uri.parse('http://localhost:8080/Flutter/JSP/restaurant_insert.jsp?name=$name&phone=$phone&estimate=$estimate&lat=$lat&lng=$lng');
